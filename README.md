...
3. [资源与版本说明](resources.md)：官方文档、示例和版本敏感点；
4. 然后从 [第 01 章：环境搭建与第一个内核](01-环境搭建与第一个内核.md) 开始。
...
完成系统路径后，阅读 [官方 examples](https://github.com/tile-ai/tilelang/tree/main/examples)，选择一个算子，提交基线、边界测试、profile 报告、库对比和版本/硬件 caveat。
