...
开始，沿着“程序如何成为内核、数据为何支配性能、抽象怎样变成算子、性能如何获得解释”
这条线，最后走到一个真实算子的交付。
...
第 00～09 章是递进的主线，原第 10～12 章改为复习附录 A～C，第 13 章是
...
01 → 02 → 03 → 04 → 05 → 06 → 07 → 08 → 09；每章完成正文实验和复习附录 B 的对应练习，最后做一个小型 capstone。
