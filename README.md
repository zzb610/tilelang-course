...
这是一套面向 GPU 内核、AI 编译器和性能工程学习者的中文 TileLang 教程。主线不按 API 清单展开，
而是让读者围绕一个内核反复完成下面这条工作流：
...
在进入正文之前，先按下面的顺序读四份支撑材料，再打开第 01 章。它们决定了你之后怎么读、
怎么写实验以及遇到版本差异时上哪儿查：
...
下表给出全书十六个章节的主题、完成标志和难度，你可以据此判断当前进度与下一步该去哪：
...
三条路线对应三种投入，你可以先按自己的时间选一条起步。先用两周最小路径跑通闭环、
